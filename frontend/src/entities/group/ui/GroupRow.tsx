...
export function GroupRow({group, onDelete, onEdit}: Props) {
    return (
        <Row key={group.id}>
                ...
                <div className="flex-1">
                    ...
                    <div className="text-gray-500 text-sm">{group.course}</div>
                </div>

                <div className="mr-4 text-left w-[150px]">
                    <div className="text-sm text-gray-500 mb-1">Преподаватель</div>
                    <div className="font-semibold text-sm">{group.teacherName}</div>
                </div>
